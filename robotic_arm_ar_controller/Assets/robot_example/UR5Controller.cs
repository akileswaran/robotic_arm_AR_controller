...
public class UR5Controller : MonoBehaviour {
    ...
    private float[] upperLimit = { 180f, 90f, 150f, 150f, 180f, 180f };
    private float[] lowerLimit = { -180f, -90f, -150f, -150f, -180f, -180f };
...
#else
        int labelHeight = 80;
        GUI.skin.label.fontSize = GUI.skin.box.fontSize = GUI.skin.button.fontSize = 80;
#endif
